...
test('uses the bulletin title and internal scrolling for management details', () => {
  ...
  assert.match(announcementDetailSource, /:text="item\.stateText"/)
  assert.match(announcementDetailSource, /resolveAnnouncementStateLabel\(props\.record\?\.state, item\.value\)/)
