<template>
  <section class="resource-card device-access-card">
    <h3 class="resource-card-title">{{ t('packages.ProjectHome.group_access') }}</h3>
...
<script setup lang="ts" name="DeviceAccessCard">
...
const accessRows = computed(() => props.rows.filter(r => r.group === 'access'))
</script>
